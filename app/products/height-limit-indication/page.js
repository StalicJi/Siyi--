...
const HeightLimitIndication = () => {
  const selectedProduct = products.find((product) => product.id === 4);
  return (
    <Fragment>
      <div className=" relative">
        ...
        <div className="bg-[#f1f1f1]">
          <div className="text-3xl uppercase text-center pt-20 pb-20 max-md:text-xl max-lg:py-10">
            ...
            <p className="mt-2 text-xl text-rose-700">- 車道限高指示 -</p>
          </div>
...
export default HeightLimitIndication;
